 ...
 * Bleeds to the viewport edge on phones so the first chip shares the hero's left edge.
 */
export function NextUp({ items, activeId, onSelect }: NextUpProps) {
  if (items.length === 0) return null;
  return (
    <div className="-mx-4 flex gap-2 overflow-x-auto px-4 sm:mx-0 sm:px-0" aria-label="Next up">
