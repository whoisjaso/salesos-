  ...
  return (
    <div className="mx-auto flex max-w-[640px] flex-col gap-4">
      <div className="flex items-baseline justify-between">
        ...
        <span className="tabular text-[13px] text-fg-subtle">{rows.length} to review</span>
      </div>
                ...
                <Link href={`/review?call=${r.callId}`} className="flex items-center gap-3 px-4 py-3 transition-colors hover:bg-hover motion-reduce:transition-none">
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="mt-1.5 flex flex-wrap items-center gap-1.5">
                      ...
                      {r.needsConfirm ? <span className="tag border-[color:var(--perf-attention-line)] text-perf-attention">Needs confirm</span> : null}
                    </span>
                  </span>
